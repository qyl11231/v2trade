...
public final class TimeUtil {
    ...
    /**
     * 将 UTC 毫秒时间戳格式化为上海时间字符串（兼容旧代码）
     * 
     * @param epochMilli UTC 毫秒时间戳
     * @return 上海时区的时间字符串
     * @deprecated 建议使用 formatAsShanghaiString(Instant) 替代
     */
    @Deprecated
    public static String formatAsShanghaiString(long epochMilli) {
        return formatAsShanghaiString(fromEpochMilli(epochMilli));
    }

    /**
     * 将 UTC 毫秒时间戳格式化为 UTC 时间字符串（兼容旧代码）
     * 
     * @param epochMilli UTC 毫秒时间戳
     * @return UTC 时间字符串
     * @deprecated 建议使用 formatAsUtcString(Instant) 替代
     */
    @Deprecated
    public static String formatAsUtcString(long epochMilli) {
        return formatAsUtcString(fromEpochMilli(epochMilli));
    }
    ...
    /**
     * 将毫秒时间戳对齐到分钟起始点（向下取整，兼容旧代码）
     * 
     * @param epochMilli UTC 毫秒时间戳
     * @return 对齐后的 UTC 毫秒时间戳
     * @deprecated 建议使用 alignToMinuteStart(Instant) 替代
     */
    @Deprecated
    public static long alignToMinuteStart(long epochMilli) {
        return (epochMilli / 60000) * 60000;
    }
