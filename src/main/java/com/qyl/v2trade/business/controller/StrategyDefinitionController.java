...
import com.qyl.v2trade.business.model.dto.StrategyDefinitionRequest;
import com.qyl.v2trade.business.model.dto.StrategyDefinitionVO;
...
public class StrategyDefinitionController {
    ...
    public Result<com.qyl.v2trade.business.model.dto.StrategyDetailVO> getStrategyDetail(
            @RequestHeader(value = "X-User-Id", required = false) Long userId,
            @PathVariable Long strategyId) {
        ...
        try {
            com.qyl.v2trade.business.model.dto.StrategyDetailVO detail = strategyDefinitionService.getStrategyDetail(strategyId, userId);
