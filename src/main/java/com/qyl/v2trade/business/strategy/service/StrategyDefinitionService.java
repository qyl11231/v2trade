...
public interface StrategyDefinitionService extends IService<StrategyDefinition> {
     ...
     * @return 创建的策略定义
     */
    StrategyDefinition createStrategyComplete(Long userId, StrategyCreateRequest request);
     ...
     * @return 更新后的策略定义
     */
    StrategyDefinition updateStrategyComplete(Long strategyId, Long userId, StrategyCreateRequest request);
     ...
     * @return 策略完整详情
     */
    StrategyDetailVO getStrategyDetail(Long strategyId, Long userId);
}
